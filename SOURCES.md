...
| Upwork portfolio | how to do it right | <https://support.upwork.com/hc/en-us/articles/360016144974-How-to-enhance-your-freelancer-profile> and <https://community.upwork.com/t5/Freelancers/Portfolio-image-sizes/m-p/1507898> | 2026-08-18 | a platform's own rules for its own form; read for the 4:3 thumbnail (1000×750 recommended, 400×300 minimum, 4000×4000 maximum), the 40-character title and the 300-character description. The help page refuses automated fetching, so the numbers are from the search summary and the community thread and are to be checked against the form itself before publishing |
| Homebrew | how to do it right | <https://docs.brew.sh/Cask-Cookbook> | 2026-08-18 | the policy of a repository that moves. Read on 18 August for `uninstall quit:` (runs on upgrade and reinstall), `signal:` (skipped on upgrade unless `on_upgrade: :signal`) and the flight blocks: `postflight_steps` are declarative file operations, the Ruby `postflight` block is kept for third-party taps |
